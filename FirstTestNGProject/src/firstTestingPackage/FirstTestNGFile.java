...
@Test (priority=0)
	  public void InvalidLogin() throws Exception {
			...
			signOnPage.enterUsername(ConstantVariables.UsernameWrong);
			signOnPage.enterpassword(ConstantVariables.passwordWrong);
			signOnPage.Login();
			Assert.fail();
...
//-------------------Scenario 2 Reserve a Return Ticket----------
  ...
  public void Purchase() { 
	    reservationPage.Buy();
	    String expecTitle ="$212 USD" ;
	    String actualTitle="$212 USD";
	    Assert.assertEquals(expecTitle, actualTitle);
	
  }
  
 
  //Please change it to relevant FromMail,Password,ToMAIL BEFORE running the code
  @AfterSuite
	public void tearDown(){
	    LandingPage_Home.closeBrowser();
		sendPDFReportByGMail("Krishnambikac@gmail.com", "kichu0474", "harigovindr@gmail.com", "PDF Report", "");
	}
